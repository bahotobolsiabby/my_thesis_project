...
def get_cube_position_relative_to_panda():
    ...
    cube_relative = [
        cube_world[0] - panda_world[0],
        cube_world[1] - panda_world[1],
        cube_world[2] - panda_world[2]
    ]

    return cube_relative
...
def get_cube_ik_targets():
    ...
    # If the arm still moves away from the cube, change this to -1
    Y_DIRECTION = 1.0

    cube_y = cube_y * Y_DIRECTION

    # Do not aim directly at the cube center.
    # Aim slightly above it first, then lower near it.
    above_cube = [
        cube_x,
        cube_y,
        cube_z + 0.12
        ...
        if above_cube is not None:
            ...
            if ik_target is not None and step_count % IK_SOLVE_INTERVAL == 0:
                ...
                if step_count % 100 == 0:
                    ...
                    print("Cube relative:", get_cube_position_relative_to_panda())
